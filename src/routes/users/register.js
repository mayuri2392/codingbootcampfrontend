  ...
  render(){
    return (<Layout>
      ...
      <div className="form-group">
        ...
        <input name="name" type="name" onChange={this.updateVal} className="form-control" id="exampleInputName" aria-describedby="nameHelp" placeholder="Enter name" />
        <small id="namelHelp" className="form-text text-muted">What do people call you</small>
      </div>
      <div className="form-group">
